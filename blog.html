...
<head>
  ...
  <title>Noticias| Tus tramites en Vzla</title>
        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                <figure class="mbr-figure mbr-figure--wysiwyg mbr-figure--full-width mbr-figure--no-bg mbr-figure--caption-outside-bottom">
                    <div><iframe width="560" height="315" src="https://www.youtube.com/embed/r2XboXhUaYA" frameborder="0" allowfullscreen></iframe></div>
