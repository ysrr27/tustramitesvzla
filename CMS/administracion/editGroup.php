            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <form  data-parsley-validate class="form-horizontal form-label-left"  name="cretaeGroup" id="cretaeGroup">
                  <input type="hidden" name="idGroup" id="idGroup" value="<?=$idGrupo?>">
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="grupoNombre">Nombre Grupo<span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="grupoNombre" name="grupoNombre" value="<?=$m_grupo_nombre?>" required="required" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="descripconGrupo" name="descripconGrupo" value="<?=$m_grupo_descripcion?>" required="required" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
