                ...
                <div class="x_content">
                  ...
                  <div class="row">
                    ...
                    $idCliente=strip_tags(htmlentities(mysqli_real_escape_string($link, $_GET["idCliente"]))); 
                     $QueryClientes="SELECT * FROM m_clientes WHERE m_cliente_id='$idCliente' ORDER BY m_cliente_nombre ASC LIMIT 0,1";
                  } 
                  else{
                     $QueryClientes="SELECT * FROM m_clientes WHERE m_cliente_estatus='1'  ORDER BY m_cliente_nombre ASC LIMIT 0,9";
                  }
                    ...
                    if (mysqli_num_rows($query) ==0) {
                      ...
                      while($row=mysqli_fetch_array($query)){
                        ...
                        $m_cliente_created_at=$row["m_cliente_created_at"];
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12" id="Cliente<?=$m_cliente_id?>">
                          <div class="well profile_view">
                            <div class="col-sm-12">
                              <h4 class="brief"><i><?php echo $m_cliente_nombre." ".$m_cliente_apellido; ?></i></h4>
                              <div class="left col-xs-7">
                                <p><strong>Datos de contacto: </strong> </p>
                                <ul class="list-unstyled">
                                  <li><i class="fa fa-phone"></i> <?=$m_cliente_numeroTelefono?> </li>
                                  <li><i class="fa fa-envelope-o"></i> <?=$m_cliente_email?> </li>
                                  <li><i class="fa fa-flag"></i> <?=$m_cliente_pais?> </li>
                                  <div><i class="fa fa-map-marker"></i> <?=$m_cliente_direccion?></div>
                                </ul>
                              </div>
