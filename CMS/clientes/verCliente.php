...
<!-- <div class="modal-footer">
  ...
  <h3><?=$m_cliente_razonSocial?></h3>

  <ul class="list-unstyled user_data">
    <li><i class="fa fa-user user-profile-icon"></i> <?=$m_cliente_nombreContacto?>
    </li>

    <li>
      <i class="fa fa-phone user-profile-icon"></i> <?=$m_cliente_telefono?>
    </li>

    <li class="m-top-xs">
      <i class="fa fa-mobile user-profile-icon"></i> <?=$m_cliente_telefonoContacto?>
    </li>
  </ul>

  <a class="btn btn-success" id="Editar" data-id="<?=$idCliente?>"><i class="fa fa-edit m-right-xs"></i>Editar Cliente</a>
  <br />
...
$("#Editar").click(function (e) {
  ...
  window.location.href = 'editCliente.php?idCliente='+idCliente;
});
