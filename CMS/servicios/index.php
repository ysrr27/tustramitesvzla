                ...
                <div class="x_content">
                  ...
                  <form class="form-horizontal form-label-left" method="POST" action="addServicio.php" data-parsley-validate id="formServicios" name="formServicios" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      ...
                      <input type="text" name="tituloServicio" class="form-control has-feedback-left" id="tituloServicio" placeholder="Nombre del Servicio">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      ...
                      <select class="selectpicker" multiple name="recaudos[]">                       
                       ...
                       while ($rowRecaudos=mysqli_fetch_array($queryRecaudos)) {
                        ...
                        ?>
                        <option value="<?=$m_recaudo_id?>"><?=$m_recaudo_nombre?></option>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      ...
                      <div class="icon-picker" data-pickerid="fa" data-iconsets='{"fa":"Seleccione el ícono"}'>
                        <input type="text" size="1" name="iconoServicio" style="border:0px; color:#FFFFFF;" />
                      </div>
                    </div>
